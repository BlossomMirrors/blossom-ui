...
bool WidgetExplorer::eventFilter(QObject *object, QEvent *event)
{
    ...
    //             if( !type.isEmpty() )
    //             {
    //                 QTextStream( stdout ) << "BlossomUI::WidgetExplorer::eventFilter - widget: " << object << " (" << object->metaObject()->className() <<
    ...
    case QEvent::MouseButtonPress: {
        ...
        QTextStream(stdout) << "BlossomUI::WidgetExplorer::eventFilter -"
