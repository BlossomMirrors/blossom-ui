...
/** contains utility functions used at multiple places in both blossomui style and blossomui window decoration */
...
public:
    ...
    //* slider handle
    void renderSliderHandle(QPainter *, const QRect &, const QColor &, const QColor &, const bool focus, bool sunken) const;
