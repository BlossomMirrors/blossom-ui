...
#include "blossomuistyleconfigmodule.h"

#include <KPluginFactory>

K_PLUGIN_CLASS_WITH_JSON(BlossomUI::ConfigurationModule, "blossomuistyleconfig.json")

#include "blossomuistyleconfigmodule.moc"
