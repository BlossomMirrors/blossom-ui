#ifndef blossomui_core_render_controls_itemviewcontrol_h
#define blossomui_core_render_controls_itemviewcontrol_h
...
public:
  explicit ItemViewControl(const Style *style) : _style(style) {}
